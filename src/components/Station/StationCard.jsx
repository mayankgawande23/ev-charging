...
export default function StationCard({ station }) {
  return (
    <article className="group rounded-[26px] border border-slate-200 bg-white p-4 transition duration-300 hover:-translate-y-1 hover:shadow-soft dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="mb-4 flex flex-wrap gap-2">
        ...
        <StatusBadge tone="orange">₹{station.priceMin}-{station.priceMax}/kWh</StatusBadge>
      </div>
      ...
      <div className="mt-5 flex gap-3">
        ...
        <button className="rounded-full bg-brand-green px-4 py-2 text-sm font-medium text-white transition hover:scale-[1.02]">
          Book Now
        </button>
      </div>
    </article>
